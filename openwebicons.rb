...
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/css', 'openwebicons.css'), File.join(ASSETS_DIR, 'css/')
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/font', 'openwebicons.eot'), File.join(ASSETS_DIR, 'font/')
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/font', 'openwebicons.svg'), File.join(ASSETS_DIR, 'font/')
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/font', 'openwebicons.ttf'), File.join(ASSETS_DIR, 'font/')
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/font', 'openwebicons.woff'), File.join(ASSETS_DIR, 'font/')
FileUtils.cp File.join(ROOT_DIR, 'openwebicons/font', 'openwebicons.woff2'), File.join(ASSETS_DIR, 'font/')


# the icon vars
vars = File.read(File.join(ROOT_DIR, 'openwebicons/sass', '_vars.scss'))
